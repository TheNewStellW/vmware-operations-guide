...
- Cost. Compare your cost with other cloud providers as IaaS is essentialy a commodity.
...
More senior than Level 1. May specialise is some areas (e.g. vSAN, networking).

Perform advance troubleshooting, which often requires logs analysis.
...
Utilization and contention are explained further in the Performance Management chapter.
