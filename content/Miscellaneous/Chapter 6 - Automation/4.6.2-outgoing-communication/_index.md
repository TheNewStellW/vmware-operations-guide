...
![](4.6.2-fig-2.png "Automated Actions Outbound Instance")
...
![](4.6.2-fig-11.png "MS Teams webhook payload template example")
...
![](4.6.2-fig-12.png "Alert Notifications sending data to RabbitMQ queues")
